...
import Avatar from "../assets/Avatars/mansi_dp.jpeg";
      ...
      <div className="section gap-16 md:gap-1 md:justify-between items-center md:flex-row-reverse">
        ...
        <div className="pl-2 xs:pl-8 flex flex-col gap-3 justify-center text-gray-200 w-max md:w-3/5">
          ...
          <AnimatedWrapper delay={0.35}>
            ...
            <p>A passionate coder and aspiring software engineer.Fuelled by creativity and curiosity, I specialize in crafting modern, user-friendly web applications using cutting-edge technologies.</p>
          </AnimatedWrapper>
